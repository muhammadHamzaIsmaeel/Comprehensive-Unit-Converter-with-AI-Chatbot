...
# with col2:
#     st.image("https://avatars.githubusercontent.com/u/your_github_id?s=200&v=4", width=150)  # Replace with your image URL or local path
#     st.markdown("**Developed by: Muhammad Hamza**")
#     st.markdown("[GitHub](https://github.com/your_github_username)") # Replace with your GitHub username
#     st.markdown("[LinkedIn](https://linkedin.com/in/your_linkedin_profile)") # Replace with your LinkedIn profile
...
#     return meters * 100, "Multiply by 100"  # Improved formula description
# def centimeters_to_meters(centimeters):
#     return centimeters / 100, "Divide by 100"  # Improved formula description
# def meters_to_feet(meters):
#     return meters * 3.28084, "Multiply by 3.28084" # Improved formula description
# def feet_to_meters(feet):
#     return feet / 3.28084, "Divide by 3.28084"  # Improved formula description
# def miles_to_kilometers(miles):
#     return miles * 1.60934, "Multiply by 1.60934" # Improved formula description
# def kilometers_to_miles(kilometers):
#     return kilometers / 1.60934, "Divide by 1.60934"  # Improved formula description

# # Mass
# def kilograms_to_pounds(kilograms):
#     return kilograms * 2.20462, "Multiply by 2.20462" # Improved formula description
# def pounds_to_kilograms(pounds):
#     return pounds / 2.20462, "Divide by 2.20462"  # Improved formula description
# def grams_to_ounces(grams):
#     return grams * 0.035274, "Multiply by 0.035274" # Improved formula description
# def ounces_to_grams(ounces):
#     return ounces / 0.035274, "Divide by 0.035274"  # Improved formula description

# # Temperature
# def celsius_to_fahrenheit(celsius):
#     return (celsius * 9/5) + 32, "(°C * 9/5) + 32"  # Improved formula description
# def fahrenheit_to_celsius(fahrenheit):
#     return (fahrenheit - 32) * 5/9, "(°F - 32) * 5/9"  # Improved formula description
# def celsius_to_kelvin(celsius):
#     return celsius + 273.15, "°C + 273.15"  # Improved formula description
# def kelvin_to_celsius(kelvin):
#     return kelvin - 273.15, "K - 273.15"  # Improved formula description

# # Area
# def square_meters_to_square_feet(square_meters):
#     return square_meters * 10.764, "Multiply by 10.764"  # Improved formula description
# def square_feet_to_square_meters(square_feet):
#     return square_feet / 10.764, "Divide by 10.764"  # Improved formula description

# # Digital Storage
# def bytes_to_kilobytes(bytes_value):
#     return bytes_value / 1024, "Divide by 1024"  # Improved formula description
# def kilobytes_to_bytes(kilobytes_value):
#     return kilobytes_value * 1024, "Multiply by 1024"  # Improved formula description
# def megabytes_to_gigabytes(megabytes):
#     return megabytes / 1024, "Divide by 1024"  # Improved formula description
# def gigabytes_to_megabytes(gigabytes):
#     return gigabytes * 1024, "Multiply by 1024"  # Improved formula description

# # Speed
# def kmh_to_mph(kmh):
#     return kmh * 0.621371, "Multiply by 0.621371"  # Improved formula description
# def mph_to_kmh(mph):
#     return mph / 0.621371, "Divide by 0.621371"  # Improved formula description

# # Time
# def seconds_to_minutes(seconds):
#     return seconds / 60, "Divide by 60"  # Improved formula description
# def minutes_to_seconds(minutes):
#     return minutes * 60, "Multiply by 60"  # Improved formula description
# def hours_to_minutes(hours):
#     return hours * 60, "Multiply by 60"  # Improved formula description
# def minutes_to_hours(minutes):
#     return minutes / 60, "Divide by 60"  # Improved formula description

# # Pressure
# def pascals_to_psi(pascals):
#     return pascals * 0.000145038, "Multiply by 0.000145038"  # Improved formula description
# def psi_to_pascals(psi):
#     return psi / 0.000145038, "Divide by 0.000145038"  # Improved formula description
...
# # --- Streamlit App ---
# #st.title(f"{PAGE_ICON} {PAGE_TITLE}") # Moved to intro section
# #st.markdown("A versatile unit converter for various measurements, enhanced with AI assistance.") #Moved to intro section

# unit_type = st.selectbox("Select Unit Type", list(UNIT_TYPES.keys()))
# unit_from, unit_to = st.columns(2)

# with unit_from:
#     unit_from_selected = st.selectbox("From", UNIT_TYPES[unit_type], index=0)  # Added default selection
# with unit_to:
#     unit_to_selected = st.selectbox("To", UNIT_TYPES[unit_type], index=1 if len(UNIT_TYPES[unit_type]) > 1 else 0)  # Added default selection

# value_to_convert = st.number_input(f"Enter {unit_from_selected} Value", value=1.0, step=0.1)  # Added step
...
# # --- AI Chatbot Section ---
# st.markdown("---")
# st.subheader("AI-Powered Calculation Assistant")  # More professional title

# st.markdown("Need help with calculations or understanding conversions? Ask the AI assistant below.")
...
#             return "I can only help with calculation-based questions related to unit conversions and calculations. How can I assist you?"  # More specific message
